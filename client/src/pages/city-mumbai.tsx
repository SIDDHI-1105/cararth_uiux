...
export default function MumbaiCityPage() {
  ...
  const cityData = {
    ...
    marketInsights: [
      { label: "Active Listings", value: "80+", icon: Search },
      { label: "Avg. Price Range", value: "₹5-15L", icon: TrendingUp },
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-12 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary mb-4">
            ...
            <span className="text-sm font-medium">{cityData.name}, Maharashtra</span>
          </div>
          ...
          <CardContent className="p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <h3 className="font-semibold text-lg mb-3">Mumbai Market Insights</h3>
                <p className="text-muted-foreground">
                  Get exclusive access to {cityData.name}'s premium car market data including price trends, 
                  demand patterns, and best deals across the Metropolitan Region.
                </p>
              </div>
