...
export default function DelhiCityPage() {
  ...
  const cityData = {
    ...
    marketInsights: [
      { label: "Active Listings", value: "100+", icon: Search },
      { label: "Avg. Price Range", value: "₹4-12L", icon: TrendingUp },
          ...
          <CardContent className="p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <h3 className="font-semibold text-lg mb-3">NCR-Wide Coverage</h3>
                <p className="text-muted-foreground">
                  Access comprehensive listings across Delhi, Noida, Gurgaon, and Ghaziabad. 
                  Our platform aggregates inventory from multiple sources to give you the widest selection.
                </p>
              </div>
