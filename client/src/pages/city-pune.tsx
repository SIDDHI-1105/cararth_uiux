...
export default function PuneCityPage() {
  ...
  const cityData = {
    ...
    marketInsights: [
      { label: "Active Listings", value: "60+", icon: Search },
      { label: "Avg. Price Range", value: "₹3-9L", icon: TrendingUp },
          ...
          <CardContent className="p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <h3 className="font-semibold text-lg mb-3">Pune Market Insights</h3>
                <p className="text-muted-foreground">
                  Get access to comprehensive {cityData.name} market data with price trends, demand patterns, and best deals 
                  across the city's automotive landscape.
                </p>
              </div>
