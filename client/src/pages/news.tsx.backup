          ...
          <TabsContent value="intelligence" className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {marketInsightsPosts.length === 0 ? (
                ...
                <Card 
                  key={post.id} 
                  className="bg-white dark:bg-gray-900 hover:shadow-lg cursor-pointer transition-all duration-300 border border-gray-200 dark:border-gray-800" 
          ...
          <TabsContent value="guides" className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="mt-8">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-3 leading-relaxed">
                          Complete Swift buying guide with 220+ listings analysis, variant comparison (VXi vs ZXi), 
                          AMT vs Manual transmission, model year recommendations, and ownership costs.
                        </p>
                        <div className="flex flex-wrap items-center gap-3 text-xs text-gray-600 dark:text-gray-400 mb-3">
                          <span className="flex items-center gap-1">
                            <Calendar className="h-3 w-3" />
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-3 leading-relaxed">
                          Complete Innova buying guide with city-wise pricing, best variants (Crysta 2.4/2.8), 
                          inspection checklist, ownership costs, and reliability insights for India's best MPV.
                        </p>
                        <div className="flex flex-wrap items-center gap-3 text-xs text-gray-600 dark:text-gray-400 mb-3">
                          <span className="flex items-center gap-1">
                            <Calendar className="h-3 w-3" />
                          ...
                          <Badge variant="outline" className="text-xs">Innova</Badge>
                ...
                {/* Guide 7: Dealers Hyderabad 2025 */}
                <Card className="hover:shadow-md transition-shadow mb-4 border-orange-200 dark:border-orange-900">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0 mt-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-3 leading-relaxed">
                          Complete dealer guide covering Cars24 (1,681 cars), Spinny (1,075+ cars), CarWale (61+ dealers), 
                          Maruti True Value (376-point inspection), locations, warranties, and inspection standards.
                        </p>
                        <div className="flex flex-wrap items-center gap-3 text-xs text-gray-600 dark:text-gray-400 mb-3">
                          <span className="flex items-center gap-1">
                            <Calendar className="h-3 w-3" />
