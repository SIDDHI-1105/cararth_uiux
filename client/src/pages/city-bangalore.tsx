...
export default function BangaloreCityPage() {
  ...
  const cityData = {
    ...
    marketInsights: [
      { label: "Active Listings", value: "70+", icon: Search },
      { label: "Avg. Price Range", value: "₹4-10L", icon: TrendingUp },
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-12 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary mb-4">
            ...
            <span className="text-sm font-medium">{cityData.name}, Karnataka</span>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  Perfect for the tech-savvy buyer in India's Silicon Valley.
                </p>
              </div>
