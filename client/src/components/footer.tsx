          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center mb-4">
              <img 
                src={logoImage} 
                alt="CarArth" 
                className="block h-10 w-auto max-w-[clamp(180px,24vw,300px)] object-contain object-left opacity-80 hover:opacity-100 transition-opacity duration-300 dark:opacity-80 drop-shadow-sm"
              />
            </Link>
