...
import logoImage from "@assets/generated_images/CarArth_logo_with_asterisk_a6861ed0.png";
            ...
            <Link href="/" className="flex-shrink-0" data-testid="link-home">
              <div className="flex items-center group">
                <img 
                  src={logoImage} 
                  alt="CarArth" 
                  className="block h-12 sm:h-16 w-auto max-w-[280px] sm:max-w-[320px] object-contain object-left transition-transform duration-300 hover:scale-105"
                />
              </div>
            </Link>
          </div>
